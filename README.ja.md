...
- 1つのIDEセッションで標準コピーが10回成功すると、通知が有効な場合に、そのプラグインバージョンで1回だけ非モーダルの正直なレビュー依頼を表示できます。**Review** は公式の [Marketplaceレビューページ](https://plugins.jetbrains.com/plugin/30262-copy-selection-context/reviews)を開き、**Later** は現在のバージョンで以後表示せず、**Don't ask again** は永久に表示を抑止します。通知を無効にした場合は、設定の受動的なリンクだけを利用できます。
