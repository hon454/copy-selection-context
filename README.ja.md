...
現在はコレクションサービスと追加アクションの実装段階です。出力・コピーと管理ツールウィンドウは [#75](https://github.com/hon454/copy-selection-context/issues/75)、[#74](https://github.com/hon454/copy-selection-context/issues/74) に続きます。検証用の[サンプル選択範囲](docs/samples/context-collection/README.md)を用意しています。
