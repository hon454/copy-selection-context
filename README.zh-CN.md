...
- 在一个 IDE 会话中成功执行 10 次标准复制后，若通知已启用，可为当前插件版本显示一次非模态的诚实评价请求。**Review** 会打开官方 [Marketplace 评价页面](https://plugins.jetbrains.com/plugin/30262-copy-selection-context/reviews)，**Later** 会跳过当前版本后续请求，**Don't ask again** 会永久禁止提示。通知关闭时，只提供设置中的被动链接。
