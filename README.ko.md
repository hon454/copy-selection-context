...
에디터 하위 메뉴나 Find Action에서 **컨텍스트 컬렉션에 추가**를 실행하세요. **컨텍스트 컬렉션 열기**는 에디터 없이도 오른쪽 도구 창을 엽니다. 추가할 때 에디터 포커스를 유지하며 창을 자동으로 열지 않습니다. Keymap에서 단축키를 지정할 수 있고 기존 단일 복사 단축키는 별개입니다.
