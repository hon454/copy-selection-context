...
- 한 IDE 세션에서 일반 복사 액션이 10회 성공하면 알림이 켜진 경우 해당 플러그인 버전에서 한 번만 비모달 솔직한 리뷰 요청을 표시할 수 있습니다. **Review**는 공식 [Marketplace 리뷰 페이지](https://plugins.jetbrains.com/plugin/30262-copy-selection-context/reviews)를 열고, **Later**는 현재 버전의 남은 요청을 건너뛰며, **Don't ask again**은 요청을 영구적으로 억제합니다. 알림을 끄면 설정의 수동 링크만 사용할 수 있습니다.
